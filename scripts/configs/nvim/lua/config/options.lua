----------------------------------------------------------------------------------
-- File:          options.lua
-- Created:       Saturday, 24 January 2026 - 07:49 AM
-- Author:        AhmdHosni (ahmdhosny@gmail.com)
-- Link:          
-- Description:   This file has all the options and settings for neovim 
----------------------------------------------------------------------------------
...
-- adding treesitter parser location
-- Ensure the parser directory is in the runtimepath
vim.opt.rtp:prepend("/home/ahmdhosni/.local/share/nvim/site/")
